...
<?php require 'navbar/navbar.php'?>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                             <h1 class="display-1 text-white mb-md-4">Buy from farmers directly</h1>
                            <a href="auth/FarmerLogin.php" class="btn btn-primary py-md-3 px-md-5 me-3">Log In</a>
                            <a href="" class="btn btn-secondary py-md-3 px-md-5">Register</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    <div class="mb-3 pb-2">
                        ...
                        <!-- <h1 class="display-5">Agri Markextplace is a digital B2B market solution that brings together Farmers and Industrial Buyers.</h1> -->
                    </div>
                    <p class="mb-4">Farmers' hut is a digital B2B market solution that brings together Farmers and Industrial Buyers.</p>
                    <div class="row gx-5 gy-4">
                        <div class="col-sm-6">
                            <!-- <i class="fa fa-seedling display-1 text-secondary"></i> -->
                            <h4>Post offer as a seller</h4>
                            <p class="mb-0">As a seller, post offers for the agricultural crop you are looking to sell, and gain immediate access to credit-verified buyers. Or simply react to an existing buyer’s bid and start your transaction</p>
                        </div>
                        <div class="col-sm-6">
                            <!-- <i class="fa fa-award display-1 text-secondary"></i> -->
                            <h4>Post bid as a buyer</h4>
                            <p class="mb-0">As a buyer, post bids for the agricultural crop you are looking to buy. Communicate to the market what you are looking for, and get rapid reactions from interested farmers or sellers.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Features Start -->
    <div id="service" class="container-fluid bg-primary feature py-5 pb-lg-0 my-5">
        <div class="container py-5 pb-lg-0">
            <div class="mx-auto text-center mb-3 pb-2" style="max-width: 500px;">
                <h1 class="display-5 text-white">HOW IT WORKS</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-3">
                    <div class="text-white mb-5">
                        ...
                        <h4 class="text-white">Digital web-based e-commarce platform</h4>
                    </div>
                    <div class="text-white">
                        <div class="bg-secondary rounded-pill d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                            <i class="fa fa-award fs-4 text-white"></i>
                        </div>
                        <h4 class="text-white">Quality control of product</h4>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="d-block bg-white h-100 text-center p-5 pb-lg-0">
                        <p>1.Sign-up to the platform</p>
                        <p>2.Create your offer or bid</p>
                        <p>3.Set a quantity & price</p>
                        <p>4.Provide us with crop characteristics & details</p>
                        <p>5.Decide upon your preferred incoterm</p>
                        <p>6.Decide upon logistic and/or crop quality check services</p>
                        <p>7.Post your seller offer or buyer bid</p>
                        <p>8.Stay updated by email or notification centre</p>
                ...
                <div class="col-lg-3">
                    <div class="text-white mb-5">
                        ...
                        <h4 class="text-white">Logistic and Transportation</h4>
                    </div>
                    <div class="text-white">
                        <div class="bg-secondary rounded-pill d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
            ...
            <div class="row gx-5">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">Kolkata, India</p>
                            </div>
                            <div class="d-flex mb-2">
                ...
                <div class="col-lg-4 col-md-6 mt-lg-n5">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-secondary p-5">
                        ...
                        <p>Subscribe our website to get notifiaction</p>
                        <form action="">
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">Farmers' Hut</a>. All Rights Reserved.<a </div>
    </div>
    <!-- Footer End -->
