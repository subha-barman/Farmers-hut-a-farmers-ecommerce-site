            ...
            <div class="navbar-nav mx-auto py-0">
                ...
                <?php
                              if (isset($_SESSION['phonenumber'])) {
                                echo "<a href='farmerHomepage.php' class='nav-item nav-link' >Home</a>";
                                echo "<a href='MyProducts.php' class='nav-item nav-link' >Product</a>";
                                echo "<a href='FarmerProfile.php' class='nav-item nav-link' >About</a>";
                                echo "<a href='../FarmerPortal/Transactions.php' class='nav-item nav-link' >Transaction</a>";
