...
<body>
     <?php require '../navbar/navbar2.php'?>
                                   ...
                                   <div class='row'>
                                        ...
                                        <div class='col-md-6 blackgoldie'>
                                             ...
                                             <div class='row' style='padding:7px; margin-bottom:15px;' >
                                                  <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 aligncenter'> <a href='#?id=$prod_id' class='btn btn-warning border-secondary' style='color:black'><b>Edit Product</b></a></div>
